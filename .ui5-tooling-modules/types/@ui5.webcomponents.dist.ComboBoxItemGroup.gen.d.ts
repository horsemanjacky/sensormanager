 ...
 * Dynamic imports
 */
import type { IComboBoxItem, WrappingType } from "@ui5/webcomponents";
...
import type { default as ComboBoxItem } from "@ui5/webcomponents/dist/ComboBoxItem";

import type { default as ListItemBase } from "@ui5/webcomponents/dist/ListItemBase";

import type { default as Event } from "sap/ui/base/Event";

declare module "@ui5/webcomponents/dist/ComboBoxItemGroup" {
  export interface $ComboBoxItemGroupSettings extends $ListItemGroupSettings {
    /**
     * Properties
     */
     ...
     */
    moveOver?: (oEvent: ComboBoxItemGroup$MoveOverEvent) => void;
     ...
     */
    move?: (oEvent: ComboBoxItemGroup$MoveEvent) => void;
  }
  export interface ComboBoxItemGroup$MoveOverEventParameters {
    /**
  ...
  export type ComboBoxItemGroup$MoveOverEvent = Event<
    ComboBoxItemGroup$MoveOverEventParameters,
    ComboBoxItemGroup
  >;
  export interface ComboBoxItemGroup$MoveEventParameters {
    /**
     * Contains information about the moved element under `element` property.
     */
    source?: object;
  ...
  export type ComboBoxItemGroup$MoveEvent = Event<
    ComboBoxItemGroup$MoveEventParameters,
    ComboBoxItemGroup
  >;

  export default class ComboBoxItemGroup
    ...
    implements IComboBoxItem
  {
    ...
    constructor(
       ...
       */
      mSettings?: $ComboBoxItemGroupSettings
    );
    ...
    /**
     * Creates a new subclass of class "@ui5/webcomponents/dist/ComboBoxItemGroup" with name `sClassName` and enriches it with the information
    ...
    static extend<T extends Record<string, unknown>>(
       ...
       */
      oClassInfo?: sap.ClassInfo<T, ComboBoxItemGroup>,
      /**
    ...
    /**
     * Returns a metadata object for class "@ui5/webcomponents/dist/ComboBoxItemGroup".
     *
     *
     ...
     */
    getItems(): Array<ComboBoxItem> | ComboBoxItem;
     ...
     * @returns Reference to `this` in order to allow method chaining
     */
    addItem(itemValue: Array<ComboBoxItem> | ComboBoxItem): this;
     ...
     */
    insertItem(
      itemValue: Array<ComboBoxItem> | ComboBoxItem,
     ...
     */
    removeItem(
      itemValue: Array<ComboBoxItem> | ComboBoxItem | int | ID
    ): Array<ComboBoxItem> | ComboBoxItem | null;
     ...
     */
    removeAllItems(): Array<ComboBoxItem> | ComboBoxItem;

    /**
     * Checks for the provided 'ComboBoxItem' in the aggregation {@link #getItems items} and returns its index if found or -1 otherwise.
     * @returns The index of the provided control in the aggregation if found, or -1 otherwise
     */
    indexOfItem(itemValue: Array<ComboBoxItem> | ComboBoxItem): int;
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getMoveOver moveOver} event of this `ComboBoxItemGroup`.
    ...
    detachMoveOver(
       ...
       */
      fnFunctionValue: (p1: ComboBoxItemGroup$MoveOverEvent) => void,

      /**
       * Context object to call the event handler with. Defaults to this ComboBoxItemGroup itself
       */
      oListenerValue?: object
    ): this;

    /**
     * Attaches event handler `fnFunction` to the {@link #getMoveOver moveOver} event of this `ComboBoxItemGroup`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `ComboBoxItemGroup` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    attachMoveOver(
      /**
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getMove move} event of this `ComboBoxItemGroup`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachMove(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: ComboBoxItemGroup$MoveEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getMove move} event of this `ComboBoxItemGroup`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `ComboBoxItemGroup` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
