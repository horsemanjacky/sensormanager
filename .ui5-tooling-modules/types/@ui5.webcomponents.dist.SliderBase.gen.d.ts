...
declare module "@ui5/webcomponents/dist/SliderBase" {
  export interface $SliderBaseSettings extends $WebComponentSettings {
    /**
     * Properties
     */
     ...
     */
    change?: (oEvent: SliderBase$ChangeEvent) => void;

    /**
     * Fired when the value changes due to user interaction that is not yet finished - during mouse/touch dragging.
     */
    input?: (oEvent: SliderBase$InputEvent) => void;
  }
  export interface SliderBase$ChangeEventParameters {}

  export type SliderBase$ChangeEvent = Event<
    SliderBase$ChangeEventParameters,
    SliderBase
  >;
  export interface SliderBase$InputEventParameters {}

  export type SliderBase$InputEvent = Event<
    SliderBase$InputEventParameters,
    SliderBase
  >;

  export default class SliderBase extends WebComponent {
    constructor(
      /**
       * Initial settings for the new control
       */
      mSettings?: $SliderBaseSettings
    );
    ...
    /**
     * Creates a new subclass of class "@ui5/webcomponents/dist/SliderBase" with name `sClassName` and enriches it with the information
    ...
    static extend<T extends Record<string, unknown>>(
       ...
       */
      oClassInfo?: sap.ClassInfo<T, SliderBase>,
      /**
    ...
    /**
     * Returns a metadata object for class "@ui5/webcomponents/dist/SliderBase".
     *
     *
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getChange change} event of this `SliderBase`.
    ...
    detachChange(
       ...
       */
      fnFunctionValue: (p1: SliderBase$ChangeEvent) => void,

      /**
       * Context object to call the event handler with. Defaults to this SliderBase itself
       */
      oListenerValue?: object
    ): this;

    /**
     * Attaches event handler `fnFunction` to the {@link #getChange change} event of this `SliderBase`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `SliderBase` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    attachChange(
      /**
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getInput input} event of this `SliderBase`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachInput(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: SliderBase$InputEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getInput input} event of this `SliderBase`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `SliderBase` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
