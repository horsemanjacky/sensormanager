 ...
 * Dynamic imports
 */
import type { IMenuItem, MenuItemGroupCheckMode } from "@ui5/webcomponents";
...
declare module "@ui5/webcomponents/dist/MenuItemGroup" {
  export interface $MenuItemGroupSettings extends $WebComponentSettings {
    /**
     * Properties
     */
    ...
    checkMode?:
      ...
      | keyof typeof MenuItemGroupCheckMode
      | PropertyBindingInfo
      | `{${string}}`;
  ...
  export default class MenuItemGroup extends WebComponent implements IMenuItem {
    ...
    /**
     * Creates a new subclass of class "@ui5/webcomponents/dist/MenuItemGroup" with name `sClassName` and enriches it with the information
    ...
    /**
     * Returns a metadata object for class "@ui5/webcomponents/dist/MenuItemGroup".
     *
     *
    ...
    /**
     * Gets current value of property {@link #getCheckMode checkMode}.
     * Defines the component's check mode.
    ...
    /**
     * Sets a new value for property {@link #getCheckMode checkMode}.
     * Defines the component's check mode.
