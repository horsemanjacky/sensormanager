...
declare module "@ui5/webcomponents/dist/MultiComboBox" {
  export interface $MultiComboBoxSettings extends $WebComponentSettings {
     ...
     */
    noValidation?: boolean | PropertyBindingInfo | `{${string}}`;
     ...
     */
    showSelectAll?: boolean | PropertyBindingInfo | `{${string}}`;
     ...
     */
    change?: (oEvent: MultiComboBox$ChangeEvent) => void;

    /**
     * Fired when the value of the component changes at each keystroke or clear icon is pressed.
     */
    input?: (oEvent: MultiComboBox$InputEvent) => void;

    /**
     * Fired when the dropdown is opened.
     */
    open?: (oEvent: MultiComboBox$OpenEvent) => void;

    /**
     * Fired when the dropdown is closed.
     */
    close?: (oEvent: MultiComboBox$CloseEvent) => void;
  ...
  export type MultiComboBox$InputEvent = Event<
    ...
    MultiComboBox
  >;
  export interface MultiComboBox$OpenEventParameters {}

  export type MultiComboBox$OpenEvent = Event<
    MultiComboBox$OpenEventParameters,
    MultiComboBox
  >;
  export interface MultiComboBox$CloseEventParameters {}

  export type MultiComboBox$CloseEvent = Event<
    MultiComboBox$CloseEventParameters,
    MultiComboBox
  >;
  export interface MultiComboBox$SelectionChangeEventParameters {
     ...
     */
    items?: Array<IMultiComboBoxItem> | IMultiComboBoxItem;
  }
    ...
    implements IFormContent
  {
    ...
    /**
     * Creates a new subclass of class "@ui5/webcomponents/dist/MultiComboBox" with name `sClassName` and enriches it with the information
    ...
    /**
     * Returns a metadata object for class "@ui5/webcomponents/dist/MultiComboBox".
     *
     *
    ...
    /**
     * Gets current value of property {@link #getNoValidation noValidation}.
     * Defines if the user input will be prevented, if no matching item has been found
     * Default value is `false`.
     * @returns The content of the property
     */
    getNoValidation(): boolean;

    /**
     * Sets a new value for property {@link #getNoValidation noValidation}.
     * Defines if the user input will be prevented, if no matching item has been found
     * When called with a value of `null` or `undefined`, the default value of the property will be restored.
     *
     * Default value is `false`.
     * @returns Reference to `this` in order to allow method chaining
     */
    setNoValidation(noValidationValue?: boolean | null): this;
     ...
     * @returns Reference to `this` in order to allow method chaining
     */
    setShowSelectAll(showSelectAllValue?: boolean | null): this;
     ...
     */
    getItems(): Array<IMultiComboBoxItem> | IMultiComboBoxItem;
     ...
     * @returns Reference to `this` in order to allow method chaining
     */
    addItem(itemValue: Array<IMultiComboBoxItem> | IMultiComboBoxItem): this;
     ...
     */
    insertItem(
      itemValue: Array<IMultiComboBoxItem> | IMultiComboBoxItem,
     ...
     */
    removeItem(
      itemValue: Array<IMultiComboBoxItem> | IMultiComboBoxItem | int | ID
    ): Array<IMultiComboBoxItem> | IMultiComboBoxItem | null;
     ...
     */
    removeAllItems(): Array<IMultiComboBoxItem> | IMultiComboBoxItem;

    /**
     * Checks for the provided 'IMultiComboBoxItem' in the aggregation {@link #getItems items} and returns its index if found or -1 otherwise.
     * @returns The index of the provided control in the aggregation if found, or -1 otherwise
     */
    indexOfItem(itemValue: Array<IMultiComboBoxItem> | IMultiComboBoxItem): int;
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getChange change} event of this `MultiComboBox`.
    ...
    detachChange(
       ...
       */
      fnFunctionValue: (p1: MultiComboBox$ChangeEvent) => void,

      /**
       * Context object to call the event handler with. Defaults to this MultiComboBox itself
       */
      oListenerValue?: object
    ): this;

    /**
     * Attaches event handler `fnFunction` to the {@link #getChange change} event of this `MultiComboBox`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `MultiComboBox` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    attachChange(
      /**
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getInput input} event of this `MultiComboBox`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachInput(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: MultiComboBox$InputEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getInput input} event of this `MultiComboBox`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `MultiComboBox` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getOpen open} event of this `MultiComboBox`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachOpen(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: MultiComboBox$OpenEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getOpen open} event of this `MultiComboBox`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `MultiComboBox` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getClose close} event of this `MultiComboBox`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachClose(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: MultiComboBox$CloseEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getClose close} event of this `MultiComboBox`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `MultiComboBox` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getSelectionChange selectionChange} event of this `MultiComboBox`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachSelectionChange(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: MultiComboBox$SelectionChangeEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getSelectionChange selectionChange} event of this `MultiComboBox`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `MultiComboBox` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
