...
import type {
  default as DateComponentBase,
  $DateComponentBaseSettings
} from "@ui5/webcomponents/dist/DateComponentBase";
...
declare module "@ui5/webcomponents/dist/DatePicker" {
  export interface $DatePickerSettings extends $DateComponentBaseSettings {
    /**
     * Properties
     */
     ...
     */
    valueStateChange?: (oEvent: DatePicker$ValueStateChangeEvent) => void;

    /**
     * Fired after the component's picker is opened.
     */
    open?: (oEvent: DatePicker$OpenEvent) => void;

    /**
     * Fired after the component's picker is closed.
     */
    close?: (oEvent: DatePicker$CloseEvent) => void;
  }
  ...
  export type DatePicker$InputEvent = Event<
    ...
    DatePicker
  >;
  export interface DatePicker$ValueStateChangeEventParameters {
    /**
  ...
  export type DatePicker$ValueStateChangeEvent = Event<
    DatePicker$ValueStateChangeEventParameters,
    DatePicker
  >;
  export interface DatePicker$OpenEventParameters {}

  export type DatePicker$OpenEvent = Event<
    DatePicker$OpenEventParameters,
    DatePicker
  >;
  export interface DatePicker$CloseEventParameters {}

  export type DatePicker$CloseEvent = Event<
    DatePicker$CloseEventParameters,
    DatePicker
  >;
    ...
    implements IFormContent
  {
    ...
    /**
     * Creates a new subclass of class "@ui5/webcomponents/dist/DatePicker" with name `sClassName` and enriches it with the information
    ...
    /**
     * Returns a metadata object for class "@ui5/webcomponents/dist/DatePicker".
     *
     *
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getChange change} event of this `DatePicker`.
    ...
    detachChange(
       ...
       */
      fnFunctionValue: (p1: DatePicker$ChangeEvent) => void,

      /**
       * Context object to call the event handler with. Defaults to this DatePicker itself
       */
      oListenerValue?: object
    ): this;

    /**
     * Attaches event handler `fnFunction` to the {@link #getChange change} event of this `DatePicker`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `DatePicker` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    attachChange(
      /**
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getInput input} event of this `DatePicker`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachInput(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: DatePicker$InputEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getInput input} event of this `DatePicker`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `DatePicker` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getValueStateChange valueStateChange} event of this `DatePicker`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachValueStateChange(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: DatePicker$ValueStateChangeEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getValueStateChange valueStateChange} event of this `DatePicker`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `DatePicker` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getOpen open} event of this `DatePicker`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachOpen(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: DatePicker$OpenEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getOpen open} event of this `DatePicker`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `DatePicker` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getClose close} event of this `DatePicker`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachClose(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: DatePicker$CloseEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getClose close} event of this `DatePicker`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `DatePicker` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
