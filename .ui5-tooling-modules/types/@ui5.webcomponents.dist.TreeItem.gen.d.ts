...
declare module "@ui5/webcomponents/dist/TreeItem" {
  export interface $TreeItemSettings extends $TreeItemBaseSettings {
    /**
     * Properties
     */
     ...
     */
    detailClick?: (oEvent: TreeItem$DetailClickEvent) => void;
  }
  ...
  export default class TreeItem extends TreeItemBase {
    constructor(
      /**
    ...
    /**
     * Creates a new subclass of class "@ui5/webcomponents/dist/TreeItem" with name `sClassName` and enriches it with the information
    ...
    /**
     * Returns a metadata object for class "@ui5/webcomponents/dist/TreeItem".
     *
     *
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getDetailClick detailClick} event of this `TreeItem`.
    ...
    detachDetailClick(
       ...
       */
      fnFunctionValue: (p1: TreeItem$DetailClickEvent) => void,

      /**
       * Context object to call the event handler with. Defaults to this TreeItem itself
       */
      oListenerValue?: object
    ): this;

    /**
     * Attaches event handler `fnFunction` to the {@link #getDetailClick detailClick} event of this `TreeItem`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `TreeItem` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    attachDetailClick(
      /**
