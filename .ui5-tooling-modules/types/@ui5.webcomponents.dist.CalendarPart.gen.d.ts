...
declare module "@ui5/webcomponents/dist/CalendarPart" {
  export interface $CalendarPartSettings extends $DateComponentBaseSettings {
    /**
     * Properties
     */
  ...
  export default class CalendarPart extends DateComponentBase {
    constructor(
      /**
       * Initial settings for the new control
       */
      mSettings?: $CalendarPartSettings
    );
    ...
    /**
     * Creates a new subclass of class "@ui5/webcomponents/dist/CalendarPart" with name `sClassName` and enriches it with the information
    ...
    static extend<T extends Record<string, unknown>>(
       ...
       */
      oClassInfo?: sap.ClassInfo<T, CalendarPart>,
      /**
    ...
    /**
     * Returns a metadata object for class "@ui5/webcomponents/dist/CalendarPart".
     *
     *
