...
declare module "@ui5/webcomponents/dist/Popover" {
  export interface $PopoverSettings extends $PopupSettings {
    /**
     * Properties
     */
     ...
     */
    beforeOpen?: (oEvent: Popover$BeforeOpenEvent) => void;

    /**
     * Fired after the component is opened.
     */
    open?: (oEvent: Popover$OpenEvent) => void;
     ...
     */
    close?: (oEvent: Popover$CloseEvent) => void;
  }
  ...
  export type Popover$BeforeOpenEvent = Event<
    ...
    Popover
  >;
  export interface Popover$OpenEventParameters {}

  export type Popover$OpenEvent = Event<Popover$OpenEventParameters, Popover>;
  ...
  export type Popover$BeforeCloseEvent = Event<
    ...
    Popover
  >;
  export interface Popover$CloseEventParameters {}

  export type Popover$CloseEvent = Event<Popover$CloseEventParameters, Popover>;
  ...
  export default class Popover extends Popup {
    ...
    /**
     * Creates a new subclass of class "@ui5/webcomponents/dist/Popover" with name `sClassName` and enriches it with the information
    ...
    /**
     * Returns a metadata object for class "@ui5/webcomponents/dist/Popover".
     *
     *
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getBeforeOpen beforeOpen} event of this `Popover`.
    ...
    detachBeforeOpen(
       ...
       */
      fnFunctionValue: (p1: Popover$BeforeOpenEvent) => void,

      /**
       * Context object to call the event handler with. Defaults to this Popover itself
       */
      oListenerValue?: object
    ): this;

    /**
     * Attaches event handler `fnFunction` to the {@link #getBeforeOpen beforeOpen} event of this `Popover`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `Popover` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    attachBeforeOpen(
      /**
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getOpen open} event of this `Popover`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachOpen(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: Popover$OpenEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getOpen open} event of this `Popover`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `Popover` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getBeforeClose beforeClose} event of this `Popover`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachBeforeClose(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: Popover$BeforeCloseEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getBeforeClose beforeClose} event of this `Popover`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `Popover` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getClose close} event of this `Popover`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachClose(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: Popover$CloseEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getClose close} event of this `Popover`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `Popover` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
