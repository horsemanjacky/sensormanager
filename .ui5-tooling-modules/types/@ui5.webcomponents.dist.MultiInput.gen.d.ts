...
declare module "@ui5/webcomponents/dist/MultiInput" {
  export interface $MultiInputSettings extends $InputSettings {
     ...
     */
    tokens?: Array<any> | any | AggregationBindingInfo | `{${string}}`;
     ...
     */
    valueHelpTrigger?: (oEvent: MultiInput$ValueHelpTriggerEvent) => void;
     ...
     */
    change?: (oEvent: MultiInput$ChangeEvent) => void;

    /**
     * Fired when the value of the component changes at each keystroke,
     * and when a suggestion item has been selected.
     */
    input?: (oEvent: MultiInput$InputEvent) => void;

    /**
     * Fired when some text has been selected.
     */
    select?: (oEvent: MultiInput$SelectEvent) => void;

    /**
     * Fired when the user navigates to a suggestion item via the ARROW keys,
     * as a preview, before the final selection.
     */
    selectionChange?: (oEvent: MultiInput$SelectionChangeEvent) => void;

    /**
     * Fired when the suggestions picker is open.
     */
    open?: (oEvent: MultiInput$OpenEvent) => void;

    /**
     * Fired when the suggestions picker is closed.
     */
    close?: (oEvent: MultiInput$CloseEvent) => void;
  }
  ...
  export type MultiInput$InputEvent = Event<
    ...
    MultiInput
  >;
  export interface MultiInput$SelectEventParameters {}

  export type MultiInput$SelectEvent = Event<
    MultiInput$SelectEventParameters,
    MultiInput
  >;
  export interface MultiInput$SelectionChangeEventParameters {
    /**
  ...
  export type MultiInput$SelectionChangeEvent = Event<
    MultiInput$SelectionChangeEventParameters,
    MultiInput
  >;
  export interface MultiInput$OpenEventParameters {}

  export type MultiInput$OpenEvent = Event<
    MultiInput$OpenEventParameters,
    MultiInput
  >;
  export interface MultiInput$CloseEventParameters {}

  export type MultiInput$CloseEvent = Event<
    MultiInput$CloseEventParameters,
    MultiInput
  >;
    ...
    implements IFormContent, ISemanticFormContent
  {
    ...
    __implements_sap_ui_core_library_ISemanticFormContent: boolean;
    ...
    /**
     * Creates a new subclass of class "@ui5/webcomponents/dist/MultiInput" with name `sClassName` and enriches it with the information
    ...
    /**
     * Returns a metadata object for class "@ui5/webcomponents/dist/MultiInput".
     *
     *
     ...
     */
    setShowValueHelpIcon(showValueHelpIconValue?: boolean | null): this;
     ...
     * @returns Reference to `this` in order to allow method chaining
     */
    addToken(tokenValue: Array<any> | any): this;
     ...
     */
    removeToken(
      tokenValue: Array<any> | any | int | ID
    ): Array<any> | any | null;
     ...
     */
    removeAllTokens(): Array<any> | any;

    /**
     * Checks for the provided 'any' in the aggregation {@link #getTokens tokens} and returns its index if found or -1 otherwise.
     * @returns The index of the provided control in the aggregation if found, or -1 otherwise
     */
    indexOfToken(tokenValue: Array<any> | any): int;
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getValueHelpTrigger valueHelpTrigger} event of this `MultiInput`.
    ...
    detachValueHelpTrigger(
       ...
       */
      fnFunctionValue: (p1: MultiInput$ValueHelpTriggerEvent) => void,

      /**
       * Context object to call the event handler with. Defaults to this MultiInput itself
       */
      oListenerValue?: object
    ): this;

    /**
     * Attaches event handler `fnFunction` to the {@link #getValueHelpTrigger valueHelpTrigger} event of this `MultiInput`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `MultiInput` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getTokenDelete tokenDelete} event of this `MultiInput`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachTokenDelete(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: MultiInput$TokenDeleteEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getTokenDelete tokenDelete} event of this `MultiInput`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `MultiInput` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getChange change} event of this `MultiInput`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachChange(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: MultiInput$ChangeEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getChange change} event of this `MultiInput`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `MultiInput` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getInput input} event of this `MultiInput`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachInput(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: MultiInput$InputEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getInput input} event of this `MultiInput`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `MultiInput` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getSelect select} event of this `MultiInput`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachSelect(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: MultiInput$SelectEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getSelect select} event of this `MultiInput`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `MultiInput` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getSelectionChange selectionChange} event of this `MultiInput`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachSelectionChange(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: MultiInput$SelectionChangeEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getSelectionChange selectionChange} event of this `MultiInput`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `MultiInput` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getOpen open} event of this `MultiInput`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachOpen(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: MultiInput$OpenEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getOpen open} event of this `MultiInput`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `MultiInput` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getClose close} event of this `MultiInput`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachClose(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: MultiInput$CloseEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getClose close} event of this `MultiInput`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `MultiInput` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
