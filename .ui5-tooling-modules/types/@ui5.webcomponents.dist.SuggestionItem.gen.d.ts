...
declare module "@ui5/webcomponents/dist/SuggestionItem" {
  export interface $SuggestionItemSettings extends $ListItemBaseSettings {
    /**
     * Properties
     */
  ...
  export default class SuggestionItem extends ListItemBase {
    constructor(
      /**
    ...
    /**
     * Creates a new subclass of class "@ui5/webcomponents/dist/SuggestionItem" with name `sClassName` and enriches it with the information
    ...
    /**
     * Returns a metadata object for class "@ui5/webcomponents/dist/SuggestionItem".
     *
     *
