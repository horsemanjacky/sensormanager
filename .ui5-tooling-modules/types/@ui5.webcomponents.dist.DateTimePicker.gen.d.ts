...
declare module "@ui5/webcomponents/dist/DateTimePicker" {
  export interface $DateTimePickerSettings extends $DatePickerSettings {
     ...
     */
    valueStateChange?: (oEvent: DateTimePicker$ValueStateChangeEvent) => void;

    /**
     * Fired after the component's picker is opened.
     */
    open?: (oEvent: DateTimePicker$OpenEvent) => void;

    /**
     * Fired after the component's picker is closed.
     */
    close?: (oEvent: DateTimePicker$CloseEvent) => void;
  }
  ...
  export type DateTimePicker$InputEvent = Event<
    ...
    DateTimePicker
  >;
  export interface DateTimePicker$ValueStateChangeEventParameters {
    /**
  ...
  export type DateTimePicker$ValueStateChangeEvent = Event<
    DateTimePicker$ValueStateChangeEventParameters,
    DateTimePicker
  >;
  export interface DateTimePicker$OpenEventParameters {}

  export type DateTimePicker$OpenEvent = Event<
    DateTimePicker$OpenEventParameters,
    DateTimePicker
  >;
  export interface DateTimePicker$CloseEventParameters {}

  export type DateTimePicker$CloseEvent = Event<
    DateTimePicker$CloseEventParameters,
    DateTimePicker
  >;
    ...
    implements IFormContent
  {
    ...
    /**
     * Creates a new subclass of class "@ui5/webcomponents/dist/DateTimePicker" with name `sClassName` and enriches it with the information
    ...
    /**
     * Returns a metadata object for class "@ui5/webcomponents/dist/DateTimePicker".
     *
     *
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getChange change} event of this `DateTimePicker`.
    ...
    detachChange(
       ...
       */
      fnFunctionValue: (p1: DateTimePicker$ChangeEvent) => void,

      /**
       * Context object to call the event handler with. Defaults to this DateTimePicker itself
       */
      oListenerValue?: object
    ): this;

    /**
     * Attaches event handler `fnFunction` to the {@link #getChange change} event of this `DateTimePicker`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `DateTimePicker` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    attachChange(
      /**
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getInput input} event of this `DateTimePicker`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachInput(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: DateTimePicker$InputEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getInput input} event of this `DateTimePicker`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `DateTimePicker` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getValueStateChange valueStateChange} event of this `DateTimePicker`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachValueStateChange(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: DateTimePicker$ValueStateChangeEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getValueStateChange valueStateChange} event of this `DateTimePicker`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `DateTimePicker` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getOpen open} event of this `DateTimePicker`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachOpen(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: DateTimePicker$OpenEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getOpen open} event of this `DateTimePicker`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `DateTimePicker` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getClose close} event of this `DateTimePicker`.
     * The passed function and listener object must match the ones used for event registration.
     * @returns Reference to `this` in order to allow method chaining
     */
    detachClose(
       ...
       * The function to be called when the event occurs
       */
      fnFunctionValue: (p1: DateTimePicker$CloseEvent) => void,
    ...
    /**
     * Attaches event handler `fnFunction` to the {@link #getClose close} event of this `DateTimePicker`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `DateTimePicker` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
