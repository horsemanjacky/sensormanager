...
declare module "@ui5/webcomponents/dist/Button" {
  export interface $ButtonSettings extends $WebComponentSettings {
     ...
     */
    click?: (oEvent: Button$ClickEvent) => void;
  }
  ...
  export default class Button extends WebComponent implements IButton {
    ...
    /**
     * Creates a new subclass of class "@ui5/webcomponents/dist/Button" with name `sClassName` and enriches it with the information
    ...
    /**
     * Returns a metadata object for class "@ui5/webcomponents/dist/Button".
     *
     *
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getClick click} event of this `Button`.
    ...
    detachClick(
       ...
       */
      fnFunctionValue: (p1: Button$ClickEvent) => void,

      /**
       * Context object to call the event handler with. Defaults to this Button itself
       */
      oListenerValue?: object
    ): this;

    /**
     * Attaches event handler `fnFunction` to the {@link #getClick click} event of this `Button`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `Button` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    attachClick(
      /**
