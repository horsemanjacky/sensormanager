...
} from "@ui5/webcomponents/dist/TreeItemBase";
...
declare module "@ui5/webcomponents/dist/TreeItemCustom" {
  export interface $TreeItemCustomSettings extends $TreeItemBaseSettings {
    /**
     * Properties
     */
     ...
     */
    detailClick?: (oEvent: TreeItemCustom$DetailClickEvent) => void;
  }
  ...
  export default class TreeItemCustom extends TreeItemBase {
    constructor(
      /**
    ...
    /**
     * Creates a new subclass of class "@ui5/webcomponents/dist/TreeItemCustom" with name `sClassName` and enriches it with the information
    ...
    /**
     * Returns a metadata object for class "@ui5/webcomponents/dist/TreeItemCustom".
     *
     *
     ...
     */
    setHideSelectionElement(hideSelectionElementValue?: boolean | null): this;
    ...
    /**
     * Detaches event handler `fnFunction` from the {@link #getDetailClick detailClick} event of this `TreeItemCustom`.
    ...
    detachDetailClick(
       ...
       */
      fnFunctionValue: (p1: TreeItemCustom$DetailClickEvent) => void,

      /**
       * Context object to call the event handler with. Defaults to this TreeItemCustom itself
       */
      oListenerValue?: object
    ): this;

    /**
     * Attaches event handler `fnFunction` to the {@link #getDetailClick detailClick} event of this `TreeItemCustom`.
     * When called, the context of the event handler (its `this`) will be bound to `oListener` if specified,
     *  * otherwise it will be bound to this `TreeItemCustom` itself.
     * @returns Reference to `this` in order to allow method chaining
     */
    attachDetailClick(
      /**
